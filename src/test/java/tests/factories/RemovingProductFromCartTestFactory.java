...
import tests.shoppingcart.removing.RemovingProductTest;

public class RemovingProductFromCartTestFactory {
    ...
    public Object[] createInstance() throws JsonProcessingException {
        ...
        return new Object[] { new  RemovingProductTest(products) };
    }
}
